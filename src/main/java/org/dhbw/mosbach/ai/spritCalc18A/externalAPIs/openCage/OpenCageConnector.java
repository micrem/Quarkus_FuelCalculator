...
public class OpenCageConnector {
    ...
    public ApiResponseWrapper<OpenCageData> returnGeocodeForAddressInput(int streetNum, String street, int postalCode, String city) throws IOException {
        ...
        OpenCageData openCageDataResult = new OpenCageData((locationJSON.getDouble("lng")), (locationJSON.getDouble("lat")));
        System.out.println("OpenCage result: " + openCageDataResult.getLng() + "  " + openCageDataResult.getLat());
        return new ApiResponseWrapper<OpenCageData>(200,"alles gut", openCageDataResult);
    }
